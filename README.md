...
## How to Use the EXE
1. Download the `.exe` from the **Releases** tab on the right.
2. Double click to run.
3. Type in your phrases and enjoy!

## For Nerds:
To run the raw code, install the requirements and the Vosk model:
`pip install -r requirements.txt`
*(Note: You must download the Vosk English model and place it in a folder named `model` next to the script).*
